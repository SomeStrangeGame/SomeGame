...
Архив прежних архитектурных волн, решений и результатов проверок. Документ сохранён для контекста, но не описывает проект целиком в его текущем состоянии. Актуальная точка входа: [UnityProjectContext.md](../../architecture/UnityProjectContext.md).
