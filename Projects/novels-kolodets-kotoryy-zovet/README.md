...
не включает эти исправления: они сохранены в checkpoint `85b70624`.
Ветка обновлена от `origin/main` (`3e449934`) merge-коммитом `811bab3d`;
подробности и оставшиеся ограничения — [статус обновления](Art/2026-09-10-main-refresh.md).
...
не выполнены. Актуальный SDK уже получен; разрешённый слот Unity ещё требуется.
