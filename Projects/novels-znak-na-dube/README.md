...
Длительность расчётная, а история архива до его внедрения неполна. Текущий
архивный контракт дополнительно сохраняет adoption-brief, research ledger,
переносимые story-local ссылки и байты отвергнутых обложек; старые manifest
снимки не переписываются.
