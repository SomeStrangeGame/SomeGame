...
- `яр/travel/{main,alarmed,marked}.png`: opening, council, final mark.
- `лада/forager/{main,urgent,wounded}.png`: guide, flooded path, climax.
- `весна/council/{main,stern,afraid}.png`: council and iron ending.
...
## Choice/presentation/audio

- Choice icons: `touch-mark`, `study-mark`, `iron-nail`, `bronze-clapper`, `save-lada`, `save-map`.
