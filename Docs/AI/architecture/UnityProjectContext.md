...
- Текущий legacy runtime показывает заметный fallback для запрошенного
  ...
  остаётся пустым. Это описание совместимости существующего контента, а не
  authoring-контракт: новый персонажный арт производится цельными вариантами,
  а их one-address runtime adapter ещё должен быть интегрирован.
