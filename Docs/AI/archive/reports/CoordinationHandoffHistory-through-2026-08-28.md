...
Changed:
- `Docs/AI/ParallelRefactoringCoordination.md`: добавлен операционный
  протокол.
- `Docs/AI/CoordinationRuntime/`: создано стартовое пространство
  очереди.
...
Changed:
- `Docs/AI/ParallelRefactoringCoordination.md`: добавлены правила
...
- `git diff --no-index --check /dev/null
  Docs/AI/ParallelRefactoringCoordination.md`: whitespace-ошибок нет.
...
- `Docs/AI/ParallelWork.bundle-audit.md`: записан scope и результат.
...
- `Docs/AI/**`: актуализированы обзор, короткий план и история волны.
...
Changed:
- `Docs/AI/ParallelRefactoringCoordination.md`: добавлен режим ожидания
...
- `Docs/AI/ContentAuthoringGuide.md`: workflow и гарантии записи
  актуализированы без термина «перегенерировать».
- `Docs/AI/ParallelWork.character-trim-tool-safety.md`: записаны scope,
...
- `Packages/NovelsContentSdk/Editor/ContentPipeline.cs`: story build вычитает
  ...
  исключений.
- `Docs/AI/ContentAuthoringGuide.md`: зафиксировано, что группа не
...
- `Docs/AI/ParallelWork.story-streaming-experiment.md`: результаты.
...
- `Docs/AI/CharacterLayeringRules.md`: зафиксированы правила общей базы,
  волос, одежды, эмоций, регистрации слоёв и обратной сборки.

Validation:
- `git diff --check -- AGENTS.md Docs/AI/CharacterLayeringRules.md` —
  успешно.
...
Suggested next step:
- Новым чатам начинать с `Docs/AI/README.md` и читать только обязательный
...
Changed:
- `Docs/AI/rules/`: обязательные правила.
- `Docs/AI/guides/`: тематические authoring/pipeline/Ink/checklist
  руководства.
- `Docs/AI/architecture/`: обзор и архитектурные границы.
- `Docs/AI/plans/`: текущие планы и датированные измерения.
- `Docs/AI/work/parallel/`: статусы `ready-for-integration` и очередь.
- `Docs/AI/archive/parallel-work/`: integrated/completed статусы.
- `Docs/AI/archive/reports/`: исторические отчёты.
- `AGENTS.md`, `Docs/AI/README.md` и внутренние ссылки обновлены.
...
Suggested next step:
- Использовать `Docs/AI/README.md` как единственную точку маршрутизации
  документации.
...
- `Docs/AI/work/parallel/ParallelWork.queue.md` сокращён до одной
  реальной незавершённой интеграции.
- `Docs/AI/README.md` уточняет различие work и archive.
...
- В commit включены только `AGENTS.md` и структурированная документация
  `Docs/AI` без `CoordinationRuntime` и пользовательских Unity settings.
