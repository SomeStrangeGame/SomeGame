...
2026-09-08 — catalog-progress-publish: approved episode reading bar, optional version/hash-bound estimate, static/compile/live unread-card evidence and pending gates: [publication report](../archive/reports/CatalogEpisodeProgress-2026-09-08.md). Isolated clean copy from main; no story commits, registry or primary checkout changes.
