...
- Expected files: `Packages/NovelsContentSdk/Runtime/Features/Character/CharacterSpriteSetLoader.cs`, `Projects/novels-tzm/Assets/tzm.asset`, `Projects/novels-tzm/Assets/Characters/sprite-trim-manifest.asset`, шесть alias-source PNG/meta, `Docs/AI/ContentAuthoringGuide.md`, собственные coordination-файлы.
