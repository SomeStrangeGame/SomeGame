...
namespace Novels.StoryQueue
{
    internal sealed class DialogueQueueBuilder
    {
            ...
            bool hasPendingCommands)
        {
            ...
            if (frame.Presentation == BubbleContracts.BubblePresentationKind.Wardrobe
                && _dependencies.Wardrobe == null)
                throw new NotSupportedException("Wardrobe content is not supported by this player profile.");
